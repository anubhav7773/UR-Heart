...
# 19. Clerk Authentication & User Sync Schemas
class ClerkUserClaims(BaseModel):
    sub: str = Field(..., description="Unique Clerk User ID (clerk_id)")
